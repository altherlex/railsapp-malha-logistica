...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { begin_point: @map.begin_point, distance: @map.distance, end_point: @map.end_point, local: @map.local }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { begin_point: @map.begin_point, distance: @map.distance, end_point: @map.end_point, local: @map.local }
    assert_redirected_to map_path(assigns(:map))
  end
